  ...
  return (
    ...
    >
      <FloatingMascot
        ...
        duration={3.6}
      />
      <h2 className="font-display text-3xl text-ink">Pick a name</h2>
      <p className="mt-1 font-body text-sm text-ink/70">
        No sign-up. Just something to call you on the leaderboard.
      </p>
      ...
      >
        ...
        <p className="mt-1 h-4 font-body text-xs text-ink/50">
          {clean.length > 0 && !valid ? "2–18 characters" : " "}
        </p>
